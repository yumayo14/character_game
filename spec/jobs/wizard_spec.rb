          ...
          context '装備が異なる場合' do
            context '剣の場合' do
              ...
              it 'アタックポイントの合計が40になる' do
                expect(wizard.attack).to eq 40
              end
              it 'ディフェンスポイントの合計が40になる' do
                expect(wizard.defence).to eq 40
              end
            end
            context '杖の場合' do
              ...
              it '装備の補正でアタックポイントが20加算され、アタックポイントの合計が60になる' do
                expect(wizard.attack).to eq 60
              end
              it 'ディフェンスポイントの合計が20になる' do
                expect(wizard.defence).to eq 20
              end
            end
            context 'グローブの場合' do
              ...
              it 'アタックポイントの合計が30になる' do
                expect(wizard.attack).to eq 30
              end
              it 'ディフェンスポイントの合計が30になる' do
                expect(wizard.defence).to eq 30
              end
            end
          end
        end
          ...
          context '装備が異なる場合' do
            context '剣の場合' do
              ...
              it 'アタックポイントの合計が45になる' do
                expect(wizard.attack).to eq 45
              end
              it 'ディフェンスポイントの合計が35になる' do
                expect(wizard.defence).to eq 35
              end
            end
            context '杖の場合' do
              let(:equipment) { Stick.new }
              ...
              it '装備の補正でアタックポイントが20加算され、アタックポイントの合計が65になる' do
                expect(wizard.attack).to eq 65
              end
              it 'ディフェンスポイントの合計が15になる' do
                expect(wizard.defence).to eq 15
              end
            end
            context 'グローブの場合' do
              let(:equipment) { Glove.new }
              ...
              it 'アタックポイントの合計が35になる' do
                expect(wizard.attack).to eq 35
              end
              it 'ディフェンスポイントの合計が25になる' do
                expect(wizard.defence).to eq 25
              end
            end
          end
        end
        ...
        context '風の場合' do
          ...
          context '装備が異なる場合' do
            context '剣の場合' do
              ...
              it 'ディフェンスポイントの合計が25になる' do
                expect(wizard.defence).to eq 45
              end
            end
            context '杖の場合' do
              let(:equipment) { Stick.new }
