      ...
      context "属性が異なる場合" do
        ...
        context "水の場合" do
          ...
          it "アタックポイントが10、ディフェンスポイントが5上昇する" do
            expect(element.attack).to be 10
          ...
          context "装備が異なる場合" do
            context "剣の場合" do
              ...
              it "アタックポイントの合計が45になる" do
                expect(fighter.attack).to be 45
              end
              it "ディフェンスポイントの合計が35になる" do
                expect(fighter.defence).to be 35
              end
            end
            context "杖の場合" do
              let(:equipment) { Stick.new }
              ...
              it "ディフェンスポイントの合計が15になる" do
                expect(fighter.defence).to be 15
              end
            end
            context "グローブの場合" do
              let(:equipment) { Glove.new }
              ...
              it "アタックポイントの合計が35になる" do
                expect(fighter.attack).to be 35
              end
              it "装備の補正でディフェンスポイントが20加算され、ディフェンスポイントの合計が45になる" do
                expect(fighter.defence).to be 45
              end
            end
          end
        end
        context "雷の場合" do
          ...
          it "アタックポイントが15、ディフェンスポイントが0上昇する" do
            expect(element.attack).to be 15
          ...
          context "装備が異なる場合" do
            context "剣の場合" do
              ...
              it "ディフェンスポイントの合計が30になる" do
                expect(fighter.defence).to be 30
              end
            end
            context "杖の場合" do
              let(:equipment) { Stick.new }
              ...
              it "ディフェンスポイントの合計が10になる" do
                expect(fighter.defence).to be 10
              end
            end
            context "グローブの場合" do
              let(:equipment) { Glove.new }
              ...
              it "アタックポイントの合計が40になる" do
                expect(fighter.attack).to be 40
              end
          ...
          context "装備が異なる場合" do
            context "剣の場合" do
              ...
              it "属性の補正でアタックポイントが20加算され、アタックポイントの合計が55になる" do
                expect(fighter.attack).to be 55
              end
            ...
            context "杖の場合" do
              ...
              it "ディフェンスポイントの合計が25になる" do
                expect(fighter.defence).to be 25
              end
            end
            context "グローブの場合" do
              let(:equipment) { Glove.new }
              ...
              it "装備の補正でディフェンスポイントが20加算され、ディフェンスポイントの合計が55になる" do
                expect(fighter.defence).to be 55
              end
            end
          end
        end
          ...
          context "装備が異なる場合" do
            ...
            context "グローブの場合" do
              ...
              it "アタックポイントの合計が30になる" do
                expect(fighter.attack).to be 30
              end
