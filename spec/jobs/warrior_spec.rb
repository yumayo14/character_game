          ...
          context '装備が異なる場合' do
            context '剣の場合' do
              ...
              it '装備の補正でアタックポイントが20加算され、アタックポイントの合計が60になる' do
                expect(warrior.attack).to eq 60
              end
              it 'ディフェンスポイントの合計が40になる' do
                expect(warrior.defence).to eq 40
              end
            end
            context '杖の場合' do
              ...
              it 'アタックポイントの合計が40になる' do
                expect(warrior.attack).to eq 40
              end
              it 'ディフェンスポイントの合計が20になる' do
                expect(warrior.defence).to eq 20
              end
            end
            context 'グローブの場合' do
              ...
              it 'アタックポイントの合計が30になる' do
                expect(warrior.attack).to eq 30
              end
              it 'ディフェンスポイントの合計が30になる' do
                expect(warrior.defence).to eq 30
              end
            end
          end
        end
          ...
          context '装備が異なる場合' do
            context '剣の場合' do
              ...
              it '装備の補正でアタックポイントが20加算され、アタックポイントの合計が65になる' do
                expect(warrior.attack).to eq 65
              end
              it '属性の補正でディフェンスポイントが10加算され、ディフェンスポイントの合計が45になる' do
                expect(warrior.defence).to eq 45
              end
            end
            context '杖の場合' do
              let(:equipment) { Stick.new }
              ...
              it 'アタックポイントの合計が45になる' do
                expect(warrior.attack).to eq 45
              end
              it '属性の補正でディフェンスポイントが10加算され、ディフェンスポイントの合計が25になる' do
                expect(warrior.defence).to eq 25
              end
            end
            context 'グローブの場合' do
              let(:equipment) { Glove.new }
              ...
              it 'アタックポイントの合計が35になる' do
                expect(warrior.attack).to eq 35
              end
              it '属性の補正でディフェンスポイントが10加算され、ディフェンスポイントの合計が35になる' do
                expect(warrior.defence).to eq 35
              end
            end
          end
        end
          ...
          context '装備が異なる場合' do
            context '剣の場合' do
              ...
              it '装備の補正でアタックポイントが20加算され、アタックポイントの合計が70になる' do
                expect(warrior.attack).to eq 70
              end
              it 'ディフェンスポイントの合計が30になる' do
                expect(warrior.defence).to eq 30
              end
            ...
            context '杖の場合' do
              ...
              it 'アタックポイントの合計が50になる' do
                expect(warrior.attack).to eq 50
              end
              it 'ディフェンスポイントの合計が10になる' do
                expect(warrior.defence).to eq 10
              end
            end
            context 'グローブの場合' do
              let(:equipment) { Glove.new }
          ...
          context '装備が異なる場合' do
            context '剣の場合' do
              ...
              it '装備の補正でアタックポイントが20加算され、アタックポイントの合計が55になる' do
                expect(warrior.attack).to eq 55
              end
              it 'ディフェンスポイントの合計が25になる' do
                expect(warrior.defence).to eq 45
              end
            ...
            context 'グローブの場合' do
              ...
              it 'アタックポイントの合計が30になる' do
                expect(warrior.attack).to eq 25
              end
          ...
          context '装備が異なる場合' do
            context '剣の場合' do
              ...
              it '属性の補正でディフェンスポイントが10加算され、ディフェンスポイントの合計が50になる' do
                expect(warrior.defence).to eq 50
              end
            end
            context '杖の場合' do
              let(:equipment) { Stick.new }
          ...
          context '装備が異なる場合' do
            ...
            context '杖の場合' do
              ...
              it 'ディフェンスポイントの合計が15になる' do
                expect(warrior.defence).to eq 15
              end
            end
            context 'グローブの場合' do
              let(:equipment) { Glove.new }
